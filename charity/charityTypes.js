...
const ORGANIZATION_TYPES = {
  '501(c)(1)': {
    ...
    keyRestrictions: 'No Form 1024, 990 exempt. Contributions deductible only for public purposes. No Grift.',
    donations: 'Yes (public purposes)'
  },
  '501(c)(2)': {
    shortDescription: 'Property Holding',
    purpose: 'Title-holding corporations for exempt organizations. Hold property and turn over income (less expenses) to a tax-exempt parent organization.',
    keyRestrictions: 'Income must be paid to exempt parent. Limited to property management. No Grift. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(3)': {
    ...
    keyRestrictions: 'No Grift. No substantial lobbying (501(h) election allows limited lobbying). No political campaign activity. File Form 1023 once, 990 annually.',
    donations: 'Yes'
  },
  '501(c)(4)': {
    ...
    keyRestrictions: 'No Grift. Unlimited lobbying if related to purpose. Contributions not tax-deductible unless for specific purposes (e.g., fire departments). File Form 1024 once, 990 annually.',
  ...
  '501(c)(5)': {
    ...
    keyRestrictions: 'No Grift. Lobbying allowed if related to purpose. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(6)': {
    ...
    keyRestrictions: 'No Grift. Unlimited lobbying for business interests. Contributions deductible as business expenses. File Form 1024 once, 990 annually.',
  ...
  '501(c)(7)': {
    ...
    keyRestrictions: 'Non-discriminatory policy (except religion). Minimal public use (<$2,500/year or <5% receipts). Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(8)': {
    ...
    keyRestrictions: 'Must offer insurance/benefits. Non-discriminatory except for religion. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(9)': {
    ...
    keyRestrictions: 'Membership voluntary, tied to employer/union. No discrimination in benefits. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(10)': {
    ...
    keyRestrictions: 'No insurance benefits. Funds for exempt purposes. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(11)': {
    ...
    keyRestrictions: 'Funded by taxes, donations, investments. Local scope. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(12)': {
    ...
    keyRestrictions: '85%+ income from members for losses/expenses. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(13)': {
    shortDescription: 'Cemeteries',
    purpose: 'Cemetery companies operated for members or charitable purposes.',
    keyRestrictions: 'No private profit. Funds for maintenance. Contributions deductible if charitable. File Form 1024 once, 990 annually.',
  ...
  '501(c)(14)': {
    ...
    keyRestrictions: 'State-regulated. No Grift. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(15)': {
    ...
    keyRestrictions: 'Gross receipts <$500,000. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(16)': {
    shortDescription: 'Crop Finance',
    purpose: 'Cooperative organizations financing crop operations. Support agricultural activities.',
    keyRestrictions: 'Funds for crop financing. No private profit. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(17)': {
    ...
    keyRestrictions: 'Benefits only for involuntary layoffs. No Grift. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(18)': {
    shortDescription: 'Old Pensions',
    purpose: 'Employee-funded pension trusts (pre-1959). Provide pension benefits.',
    keyRestrictions: 'Employee-funded only. No diversion of funds. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(19)': {
    shortDescription: 'Veterans Groups',
    purpose: 'Veterans’ organizations providing benefits or social activities for members.',
    keyRestrictions: '75%+ members are veterans. Contributions deductible if 90%+ for exempt purposes. File Form 1024 once, 990 annually.',
  ...
  '501(c)(21)': {
    ...
    keyRestrictions: 'Specific to black lung claims. Contributions deductible. File Form 1024 once, 990 annually.',
    donations: 'Yes'
  },
  '501(c)(22)': {
    shortDescription: 'Pension Liability',
    purpose: 'Withdrawal liability payment funds. Manage employer pension liabilities.',
    keyRestrictions: 'Specific to pension plans. No Grift. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(23)': {
    shortDescription: 'Old Veterans',
    purpose: 'Veterans’ organizations (pre-1880, benefits-focused). Similar to 501(c)(19) but older.',
    keyRestrictions: 'Rare. Contributions deductible if for exempt purposes. File Form 1024 once, 990 annually.',
  ...
  '501(c)(24)': {
    ...
    keyRestrictions: 'Specific to ERISA plans. No Grift. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(25)': {
    shortDescription: 'Multi-Parent Hold',
    purpose: 'Title-holding corporations with multiple parents. Hold property for exempt orgs.',
    keyRestrictions: 'Up to 35 parents. Income to exempt orgs. No Grift. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(26)': {
    ...
    keyRestrictions: 'State-regulated. No private profit. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(27)': {
  ...
  '501(c)(28)': {
    ...
    keyRestrictions: 'Specific to railroad pensions. No Grift. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '501(c)(29)': {
    shortDescription: 'CO-OP Health',
    purpose: 'CO-OP health insurance issuers under ACA. Provide consumer-oriented health plans.',
    keyRestrictions: 'ACA-specific. No private profit. Contributions not deductible. File Form 1024 once, 990 annually.',
    donations: 'No'
  },
  '4947(a)(1)': {
    ...
    keyRestrictions: 'No Grift. Subject to private foundation rules (e.g., excise taxes, distributions). File Form 1023 once, 990 annually.',
    donations: 'Yes'
  }
};
